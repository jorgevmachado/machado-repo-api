...
4. It is recommended to create a `.env` file at the root with the variables:
   ...
   For PostgreSQL:
   ```env
   DATABASE_URL=postgresql+psycopg://user:password@localhost:5432/machadoRepoDB
   ```
### Installation
...
1. Clone the repository:
   ```bash
   git clone https://github.com/yourusername/machado-repo-api.git
   cd machado-repo-api
   ```
...
See the [open issues](https://github.com/yourusername/machado-repo-api/issues) for the full list of proposed features and known issues.
...
Project Link: [https://github.com/yourusername/machado-repo-api](https://github.com/yourusername/machado-repo-api)
...
[githubStar-url]: https://github.com/yourusername/machado-repo-api/stargazers
[githubStar-img]: https://img.shields.io/github/stars/yourusername/machado-repo-api?style=for-the-badge
[githubForks-url]: https://github.com/yourusername/machado-repo-api/network
[githubForks-img]: https://img.shields.io/github/forks/yourusername/machado-repo-api?style=for-the-badge
[githubIssues-url]: https://github.com/yourusername/machado-repo-api/issues
[githubIssues-img]: https://img.shields.io/github/issues/yourusername/machado-repo-api?style=for-the-badge
[githubLicense-url]: ./LICENSE
[githubLicense-img]: https://img.shields.io/github/license/yourusername/machado-repo-api?style=for-the-badge
